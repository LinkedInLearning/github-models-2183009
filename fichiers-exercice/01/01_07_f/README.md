...
Découvrir comment exploiter les modèles d’IA avec les GitHub Models pour créer de bons prompts, tester différents modèles IA (GPT, Llama, Mistral), et effectuer des appels API.
--
...
### [5]- Create a *Personal Access Token* (PAT)
* Go to [Developer Settings](https://github.com/settings/personal-access-tokens)
